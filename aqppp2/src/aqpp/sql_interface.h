...
namespace aqppp {
	...
	public:
		...
		*/
		...
		static double CreateBLBDbSample(SQLHANDLE& sqlconnectionhandle, int seed, std::string db_name, std::string table_name, double sample_rate, std::string sample_name, std::vector<std::string> num_dim4rand = std::vector<std::string>(), std::vector<std::string> ctg_dim4rand = std::vector<std::string>());
		...
		static double ReadBLBDb(SQLHANDLE& sqlconnectionhandle, std::vector<std::vector<double>>& o_table, std::string db_name, std::string table_name, std::string AGGREGATE_NAME, std::vector<std::string> CONDITION_NAMES);
